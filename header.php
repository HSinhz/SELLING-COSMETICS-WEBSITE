...
<body>
    ...
    <div class="container-header">
        ...
        <ul id="nav-left">
            <li><a class="text-dark text-decoration-none" href="../index.php">Trang chủ</a></li>
            ...
            <li><a class="text-dark text-decoration-none" href="../Web/loginviewbill.php">Xem đơn hàng</a></li>
            <?php 
        ...
        <?php 
                if(isset($_SESSION['username']) && isset($_SESSION['Ten'])){
                    echo '
                    <div class="nav-right">
                        <a class="text-dark text-decoration-none" href="../Web/account.php" class="name-account" style="padding: 20px">'.$_SESSION['Ten'].'</a>
                        <a class="text-dark text-decoration-none" href="../control/logout.php" class="log-in">Log out</a>
                    </div>
                    ';
                } else {
                    echo '
